...
export const q1C = document.getElementById("q1C");
export const q1D = document.getElementById("q1D");
export const q1AImg = document.getElementById("q1AImg");
...
// Q3
export const q3Title = document.getElementById("q3Title");
export const q3A = document.getElementById("q3A");
export const q3B = document.getElementById("q3B");
export const q3C = document.getElementById("q3C");
export const q3D = document.getElementById("q3D");
export const q3AImg = document.getElementById("q3AImg");
